#
#  Be sure to run `pod spec lint RemotePod.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/ericzhou2008/RemotePod.git", :tag => "0.0.1" }
  ...
  s.source_files  = "RemotePod", "RemotePod/Classes/**/*.{h,m}"
